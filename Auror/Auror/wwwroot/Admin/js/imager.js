...
(function ($) {
    ...
    $.fn.imgadd = function (options) {
        ...
        options = $.extend(options, {
            ...
            tnHeight: '120px',
            fontSize: '55px',
            plusInnerHtml: '<i class="fa fa-image" style="font-size : 100px"></i>',
        ...
        $(that).each(function (index, element) {
            ...
            $(btnPlus).click(function () {
                ...
                let fileInput = $(`<input name='${elName}' type="file" accept="image/*" multiple />`);

                let label = $(`<label for='${guid}-${ix}' class='img-thumb' style="background-image:url('/Admin/img/loader_2.gif')"></label>`)
                    .append(fileInput)
                    .css({
                        width: options.tnWidth,
                        height: options.tnHeight
